...
>The answer is "b.`seq` creates a list of numbers and `sum` adds them up".
...
>The answer is "c.The state name, the abbreviation of the state name, the state’s region, and the state’s population and total number of murders for 2010".

2.What are the column names used by the data frame for these five variables?  
```{r}
names(murders)
```
>The answer is "state", "abb", "region", "population", "total".
